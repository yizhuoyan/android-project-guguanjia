...
public class BitmapDownloader {
	...
	private com.chinasofti.guguanjia.utils.ScreenUtils.Screen mScreen = null;
	...
	public Bitmap fromLocalUrl(String imageUrl) {
		...
		try {
			...
			imagePath = FileUtils.IMGS_PATH + "/" + fileName;
