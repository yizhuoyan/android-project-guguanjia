...
import com.chinasofti.guguanjia.utils.ScreenUtils.Screen;
...
public class ImageDownloader {
	...
	public ImageDownloader(Context context) {
		...
		mContext = context;
		mScreen = ScreenUtils.getScreenPix(context);
	...
	private Bitmap getDefaultBitmap(Context context) {
		...
		Bitmap defaultBitmap = getBitmapByResId(context,
				R.mipmap.ic_launcher, DEFAULT_BITMAP_CACHE);
