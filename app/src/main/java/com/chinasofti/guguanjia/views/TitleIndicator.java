...
import com.chinasofti.guguanjia.ui.IndicatorFragmentActivity.TabInfo;
...
public class TitleIndicator extends LinearLayout implements View.OnClickListener,
    ...
    public TitleIndicator(Context context, AttributeSet attrs) {
        ...
        mTextColor = a.getColorStateList(R.styleable.TitleIndicator_indicatorTextColor);
        mSelectTextColor=a.getColorStateList(R.styleable.TitleIndicator_selectTextColor);
    ...
    public synchronized void setCurrentTab(int index) {
        ...
        setTabTextSize(oldTab, false,mTextColor);

        mSelectedTab = index;
        View newTab = getChildAt(mSelectedTab);
        newTab.setSelected(true);
        setTabTextSize(newTab, true,mSelectTextColor);
    ...
    private void setTabTextSize(View tab, boolean selected,ColorStateList mcolor) {
