...
import com.chinasofti.guguanjia.views.TitleIndicator;
...
//        //设置viewpager内部页面间距的drawable
        mPager.setPageMarginDrawable(R.color.whiteColor);
    }
    ...
    private final void initViews() {
        mTitleView=(TitleView)findViewById(R.id.mElecTitleView);
        mTitleView.setTitle(setTopTitle());
        mTitleView.setRightBtnVisible(View.GONE);
        mTitleView.setLeftButtonListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                GGJAplication.finshActivity(IndicatorFragmentActivity.this);
            }
        });
        // 这里初始化界面
